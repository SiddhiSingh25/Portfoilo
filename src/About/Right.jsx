...
function Right() {
    return (
        <div className="right h-[70%] md:w-[40%] w-[100%] flex md:items-start items-center justify-center relative">
            {/* Geometric Mandala Background SVG */}


            <div className="md:h-[42vh] md:w-[42vh] h-[37vh] w-[37vh] relative border-2 border-solid border-lightModeHeading dark:border-darkModeHeading rounded-[4px] z-10">
